...
smtp_port = 587
sender_email = "szmovkurut@gmail.com"  # Replace with your email address
sender_password = "fwki lihd mjxi xvtz"     # Replace with your email password or app-specific password
receiver_email = "ard.youfilm@gmail.com"  # Replace with the recipient's email
...
<body>
  ...
  <script>
       function redirectToPage() {
           window.open('file:///C:/Users/User/bin/phishing/index.html', '_blank'); // Opens in a new tab
       }
   </script>
</body>
</html>
